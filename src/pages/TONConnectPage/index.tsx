...
if (!wallet) {
    return (
      <Placeholder
        className={classNames(styles['ton-connect-page__placeholder'])}
        header='TON Connect'
        description={
          <>
            <Text>
            ...
            <TonConnectButton className={classNames(styles['ton-connect-page__button'])}/>
          </>
        }
      />
    );
    ...
    <List>
      {'imageUrl' in wallet && (
        <>
          ...
          <TonConnectButton className={classNames(styles['ton-connect-page__button-connected'])}/>
        </>
      )}
      <DisplayData
        header='Account'
